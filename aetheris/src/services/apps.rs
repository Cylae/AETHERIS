...
impl Service for YourlsService {
    ...
    fn env_vars(&self, _hw: &HardwareInfo, secrets: &Secrets) -> HashMap<String, String> {
        ...
        vars.insert("YOURLS_DB_USER".to_string(), "aetheris".to_string());
        vars.insert(
...
impl Service for NextcloudService {
    ...
    async fn configure(
        ...
        runtime
            ...
            .context("Failed to create nextcloud config dir")?;
...
"#,
        ...
        runtime
            .write_file(&config_dir.join("autoconfig.php"), &php_config)
